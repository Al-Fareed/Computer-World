                    ...
                    <div class="mobile-menu-area">
                        <div class="mobile-menu clearfix visible-xs visible-sm">
                            ...
                            ?>
                                <ul class="navbar-nav mr-auto">
                                    <li class="nav-item dropdown">
                                        <a class="nav-link dropdown-toggle" style="width: 90%;padding: 1em 5%;margin: 0;text-align: left;color:black;border-top: 1px solid #383838;border-top: 1px solid rgba(255,255,255,0.2);text-decoration: none;text-transform: uppercase;" href="#" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                            Hi,<?php echo $_SESSION['USER_NAME'] ?>
                                        </a>

                                        <div class="dropdown-menu" aria-labelledby="navbarDropdown" style="padding-top: 14px;">
                                            <a class="dropdown-item" href="my_order.php">Order</a></br>
                                            <a class="dropdown-item" href="my_service.php">Service</a></br>
