...
if (isset($_POST['submit'])) {
    ...
    $coust_id    = get_safe_value($conn, $_POST['cous_id']);
    ...
    if ($msg == '') {
        if (isset($_GET['id']) && $_GET['id'] != '') {
            mysqli_query($conn, "UPDATE service set Name='$name',Email='$email',Phone='$phone',addr='$address',Brand='$brand',Series='$series',Warranty='$warranty',Date='$date',Issues='$issue',coustomer_id='$coust_id',serialno='$serial_number',Estimate='$estimate',purshase_date='$purshase_date',comp_type='$comp_type',comp='$compliant',repair_code='$repair_code',defect_code='$defect_code',job_complete='$job_compl_date',delivery_date='$delivery_date'where id='$id'");
        } else {
            mysqli_query($conn, "INSERT into service(Name,Email,Phone,addr,Brand,Series, Warranty, Date, Issues,coustomer_id,added_on,service_status,serialno,Estimate,purshase_date,comp_type,comp,repair_code,defect_code,job_complete,delivery_date) values('$name','$email','$phone','$address','$brand','$series','$warranty','$date','$issue','$coust_id','$added_on','$service_status','$serial_number','$estimate','$purshase_date','$comp_type','$compliant','$repair_code','$defect_code','$job_compl_date','$delivery_date')");
        }
        header('location:service_master.php');
        die();
    }
                    ...
                    <form method="post" enctype="multipart/form-data">
                        <div class="card-body card-block">
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control" name="warrnty" required>
                            ...
                            <div class="form-group">
                                ...
                                <input type="date" name="pdate" placeholder="Enter Purshase Date" class="form-control" required value="<?php echo  $purshase_date ?>">
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <input type="date" name="jdate" placeholder="Enter Job Completion Date" class="form-control" required value="<?php echo  $job_compl_date ?>">
                            </div>
                            <div class="form-group">
                                <label for="categories" class=" form-control-label">Delivery Date</label>
                                <input type="date" name="ddate" placeholder="Enter Delivery Date" class="form-control" required value="<?php echo  $delivery_date ?>">
                            </div>
